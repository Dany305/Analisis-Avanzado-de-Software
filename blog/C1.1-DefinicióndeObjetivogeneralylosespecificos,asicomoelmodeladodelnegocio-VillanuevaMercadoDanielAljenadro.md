...
- El objetivo general de la búsqueda del conocimiento es que el usuario puede ingresar a una plataforma, donde podrá buscar diferentes tipos de tópicos que le ayudaran a obtener conocimientos necesarios para llevar acaba una tarea o solo por necesidad del conocimiento
2. Especifique tres **objetivos específicos**, recordándose que deben ser medibles, cuantificables y logrables.
- El usuario podrá tener un acceso a cualquier tipo de tópico que este necesite para la obtención de un conocimiento en concreto al ingresar a la plataforma.
- El usuario debe poder complementar el conocimiento obtenido a través de complementos gracias a la plataforma.
- Se deben agregar nuevos tópicos en un periodo de tiempo corto para que el usuario tenga acceso a mayor conocimiento. 
...
![Diagrama](../img/diagrama%20de%20negocio.png)
___
